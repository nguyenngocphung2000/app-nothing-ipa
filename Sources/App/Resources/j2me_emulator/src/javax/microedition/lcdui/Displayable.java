...
public abstract class Displayable
{
	...
	public CanvasImage platformImage;
	public CanvasGraphics gc;
	...
	public Displayable()
	{
		...
		platformImage = new CanvasImage(width, height, 0xffffffff);
	...
	public void keyPressed(KeyEvent keyEvent) {
		...
		if (listCommands==true) {
			...
			boolean handled = screenKeyPressed(keyEvent);
	...
	public boolean screenKeyPressed(KeyEvent keyEvent) { return false; }
	public void screenKeyReleased(KeyEvent keyEvent) { }
	public void screenKeyRepeated(KeyEvent keyEvent) { }
	...
	protected void renderCommands(CanvasGraphics gc)
	{
